                        ...
                        <div className="dark:bg-formBox dark:text-mainText/75 md:bg-blue-200 flex flex-col gap-3 dark:md:border-0 md:border-2 shadow-lg p-10">
                            <div className="hover:cursor-pointer flex flex-col md:flex-row items-center gap-4 md:gap-10">
                                <div onClick={() => {
                                    ...
                                    <div className="font-sans text-blue-900 dark:text-mainText/75 text-xl hover:underline">
                                        {loggedUser.username}
                                    </div>
                                </div>
                            ...
                            <form className={`dark:md:bg-formBox md:bg-blue-200 md:shadow-md rounded px-5 md:px-12 pb-8 mb-4`} onSubmit={handleSubmit}>
                                {!verification ?
                                    ...
                                    <div className="dark:text-blue-200 font-sans clear-both flex flex-col">
                                        <div className="text-center mb-5 dark:text-gray-500 text-blue-500">A verification token has been sent to the email {user.email}</div>
                                        <div className="text-center mb-5">Please verify your email.</div>
